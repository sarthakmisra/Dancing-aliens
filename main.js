function start() {
    ...
    classifier = ml5.soundClassifier('https://teachablemachine.withgoogle.com/models/Jxhly-l4x/model.json', modelReady);
...
function gotResults(error, results) {
    if (error) {
        ...
        imgI = document.getElementById('alien2');
        imgII = document.getElementById('alien3');
     imgIII = document.getElementById('alien4');
